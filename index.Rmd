...
- `theme` - szablon, na którym budujemy stronę
- `ignoreFiles` - pliki i foldery do ignorowania przy budowie strony
...
Każdy post zaczyna się od specyfikacji w YAMLu. Ciekawe opcje:
